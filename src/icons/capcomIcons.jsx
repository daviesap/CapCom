...
export const capcomIcons = {
  ...
  bookOpen: BookOpen,
  info: Info,
  issueMajorBug: WarningCircle,
  issueMinorBug: BugBeetle,
  issueNotes: Note,
  issueSeverityMajor: ArrowCircleUp,
  issueSeverityMedium: Cat,
  issueSeverityMinor: MinusCircle,
  issueWishlist: Lightbulb,
  keyInfo: FileText,
  location: Buildings,
  lock: LockSimple,
  mapPin: MapPin,
